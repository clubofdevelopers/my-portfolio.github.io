    ...
    return (
        <header className="header">
            <nav className="nav container">
                <a href="index.html" className="nav__logo" style={{fontSize:"x-large",letterSpacing:"4px"}}>
                    <span style={{ color: "#FFD700" }}>P</span>
                    <span style={{ color: "#FF7F50" }}>o</span>
                    <span style={{ color: "#FF0000" }}>r</span>
                    <span style={{ color: "#6A5ACD" }}>t</span>
                    <span style={{ color: "#FFFF00" }}>f</span>
                    <span style={{ color: "#AFEEEE" }}>o</span>
                    <span style={{ color: "#FF1493" }}>l</span>
                ...
                <div className={Toggle ? "nav__menu show-menu" : "nav__menu"}>
                    <ul className="nav__list grid">
                        ...
                        <li className="nav__item">
                            <a href="https://clubofdevelopers.blogspot.com/search" target="_blank"
                                className={activeNav === "#blog" ? "nav__link active-link" : "nav__link"} rel="noreferrer">
                                <HiOutlineMail className="nav__icon" />Blog
                            </a>
                        </li>
                        <li className="nav__item">
